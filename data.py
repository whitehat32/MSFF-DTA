...
class CPIDataset_case(Dataset):
    ...
    def __init__(self, file_path, protein_feature_manager, compound_feature_manager, args, training=False):
        self.args = args
        ...
        self.compound_smiles = self.smiles_values
        ...
        self.compound_feature_manager = compound_feature_manager
    ...
    def __getitem__(self, idx):
        ...
        compound_graph = self.compound_feature_manager.compound_graph[smiles]
        compound_degree = self.compound_feature_manager.compound_degree[smiles]
        compound_fp = self.compound_feature_manager.compound_fp[smiles]
        compound_spatial_pos = self.compound_feature_manager.compound_spatial_pos[smiles]
        return {
...
class CPIDataset(Dataset):
    ...
    def __init__(self, file_path, protein_feature_manager, compound_feature_manager, args):
        self.args = args
        self.root_data_path = args.root_data_path
        self.raw_data = pd.read_csv(file_path)
        self.smiles_values = self.raw_data['COMPOUND_SMILES'].values
...
if __name__ == "__main__":
    ...
    train_set = CPIDataset_case(galaxydb_data_path + 'prot_cold_start/train_fold0.csv', protein_feature_manager, args)
